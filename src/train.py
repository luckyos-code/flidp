...
def train(train_data, test_data, client_sampling_rates, rounds, noise_multiplier, clients_per_round, eval_after_rounds=5):
...
if __name__ == '__main__':
    ...
    print("MEAN SAMPLING RATE (1000 runs)")
